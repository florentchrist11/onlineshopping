...
<form action="" class="mb-4">
       <div class="center"> 
           ...
           <label > <p style="color:blueviolet" > New password:</p>
           <input type="password" class="form-control" name="Loginpassword" placeholder="Enter your Password ">
           </label><br>
           <label > <p style="color:blueviolet" > Confirm your password:</p>
           <input type="password" class="form-control" name="Loginpassword" placeholder="Enter your Password again ">
           </label><br>
           <label > 
